...
由于教务处登录机制改变，需要对部分模块进行重构，由于本人学业原因，暂时没精力进行重构。

如果有同学愿意接手，可以自行发PR或者fork。

### 新增功能

新增静态页面生成功能，可以手动下载教务处HTML页面，转换成静态HTML，以解决教务处登录机制改变导致的无法抓取问题。

详情移步：[静态页面生成](./schedule-static/README.md)
